...
@section('title', 'Data Project - Super Admin')
        ...
        <div class="tab-content">
            <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="{{route('superadmin.project.praproduksi')}}">
                            <div class="main-card mb-3 card">
                    ...
                    <div class="col-md-4">
                        <a href="{{route('superadmin.project.produksi')}}">
                            <div class="main-card mb-3 card">
                    ...
                    <div class="col-md-4">
                        <a href="{{route('superadmin.project.pascaproduksi')}}">
                            <div class="main-card mb-3 card">
